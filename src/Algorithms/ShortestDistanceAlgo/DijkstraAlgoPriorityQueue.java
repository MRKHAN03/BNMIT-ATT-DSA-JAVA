package Algorithms.ShortestDistanceAlgo;

import java.util.*;

public class DijkstraAlgoPriorityQueue {  //PriorityQueue
    ...
    public static List<Integer> dijkstra(int V , List<List<Pair>> adj , int S){
        ...
        while (!pq.isEmpty()){
            ...
            for (Pair neighboor :adj.get(node)){
                int v = neighboor.node;
                int w = neighboor.distance;
    ...
    public static void main(String[] args) {
        ...
        List<Integer> shortestDistArray = dijkstra(V,adj,S);
        for (int i = 0;i<V;i++){
            System.out.print("Shortest distance from node " + S + " -> " + i  +" : ");
            System.out.print(shortestDistArray.get(i) + " ");
            System.out.println();
        }
        System.out.println();
    }
